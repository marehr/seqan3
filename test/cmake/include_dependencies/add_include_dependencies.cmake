...
function (get_include_target VAR method source)
    if (method STREQUAL "TARGET")
        # e.g. dna4_test.cpp
    ...
    elseif (method STREQUAL "SOURCE")
        # e.g. alphabet/nucleotide/dna4_test.cpp
        set (target_source_file "${source}")
    elseif (method STREQUAL "HEADER")
        ...
        message (STATUS "get_include_target: method ${method} unknown")
    endif ()
    seqan3_test_component (include_target "include-${target_source_file}" TARGET_UNIQUE_NAME)

    set (${VAR} "${include_target}" PARENT_SCOPE)
endfunction ()
